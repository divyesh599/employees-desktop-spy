...
# if HOST == "First enter server ip addr here.":
#    condition
...
entry_box = Text(chatbox, padx=10, width=25, height=3, bg='#ffffff', font=font_temp, state=DISABLED)
